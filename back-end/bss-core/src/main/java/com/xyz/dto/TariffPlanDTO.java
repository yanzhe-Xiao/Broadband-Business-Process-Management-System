...
public class TariffPlanDTO {
    ...
    public record TariffPlanSearchCriteria(
        ...
        public static TariffPlanSearchCriteria withUsername(TariffPlanSearchCriteriaController old, String username) {
    ...
    public record TariffPlanSearchCriteriaController(

...
public record TicketEventDetailVO(
    ...
    public static TicketEventDetailFlowVO toTicketEventDetailFlow(TicketEventDetailVO vo){
        return TicketEventDetailFlowVO.builder()
                .eventCode(vo.eventCode)
                .happenedAt(vo.happenedAt)
                .imageUrls(vo.imageUrls)
                .note(vo.note)
        .build();
    }
